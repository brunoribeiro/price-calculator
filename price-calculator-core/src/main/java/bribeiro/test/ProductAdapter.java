...
public class ProductAdapter {
    ...
    protected String price = "nxproduct:Price";
    ...
    public void setPrice(Double value) throws NuxeoException {
        doc.setPropertyValue(price, value);
    }

    public Double getPrice() throws NuxeoException {
        return (Double) doc.getPropertyValue(price);
    }
}
